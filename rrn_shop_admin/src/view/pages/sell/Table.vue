        ...
        <div class="card-header border-0 py-5">
          ...
          <div class="card-toolbar">
            <b-button
              ...
              v-on:click.prevent="$router.push('sell/form')"
            >
              ...
              >
                ...
                <template #cell(action)="data">
                  <a
                    href="javascript:"
                    @click.prevent="
                      $router.push(`sell/form/${data.item.id}`)
                    "
...
import {
  PAGINATION_SELL_DATA,
  SET_PAGINATION,
  SET_IS_CLEAR_PAGINATION,
  CLEAR_PAGINATION,
  PUT_SELL_STATUS_DATA,
  DELETE_SELL_DATA
...
export default {
  data() {
    return {
      fields: [
        ...
        {
          key: "user.fullname",
          label: `${this.$t("PAGE.SELL.TABLE.FIELDS.CUSTOMER")}`,
        ...
        {
          key: "datetime",
          label: `${this.$t("PAGE.SELL.TABLE.FIELDS.DATETIME")}`,
          key_table: "sell.datetime",
          sortable: true,
          isFilter: true,
        ...
        {
          key: "total",
          label: `${this.$t("PAGE.SELL.TABLE.FIELDS.TOTAL")}`,
          key_table: "sell.total",
          sortable: true,
          isFilter: true,
          tdClass: "totalField"
        },
  ...
  computed: {
    ...
    isClearPagination: {
      get() {
        return this.$store.state.sell.isClearPagination;
      },
      set(value) {
    ...
    pagination: {
      get() {
        return this.$store.state.sell.pagination;
      },
      set(value) {
  ...
  methods: {
    ...
    fetchData() {
      this.$store
        .dispatch(PAGINATION_SELL_DATA, { params: this.getParams() })
        .then(({ data }) => {
          console.log(data)
    ...
    removeData(id) {
      Swal.fire({
        ...
        preview(id) {
      window.open(`${Config.PREVIEW_CONTENT_URL}/sell?id=${id}`);
    }
  }
};
</script>
