        ...
        <div class="card-header border-0 py-5">
          ...
          <div class="card-toolbar">
            <b-button
              ...
              v-on:click.prevent="$router.push('customer/form')"
            >
            ...
            <div class="table-responsive">
              ...
              >
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <a
                        href="javascript:"
                        @click.prevent="
                          $router.push(`customer/form/${data.item.id}`)
                        "
                ...
                <template #cell(action)="data">
                  <a
                    href="javascript:"
                    @click.prevent="$router.push(`customer/form/${data.item.id}`)"
...
export default {
  data() {
    return {
      fields: [
        ...
        {
          key: "total",
          label: `${this.$t("PAGE.USER.TABLE.FIELDS.SCORE")}`,
          key_table: "user.total",
          sortable: true,
          isFilter: true
        },
        {
  ...
  methods: {
    ...
    fetchData() {
      this.$store
        .dispatch(PAGINATION_CUSTOMER_DATA, { params: this.getParams() })
        .then(({ data }) => {
